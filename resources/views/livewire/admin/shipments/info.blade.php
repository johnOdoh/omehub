<div class="container-fluid p-0">
    <div class="row mb-2 mb-xl-3">
        ...
        <div class="col-auto ms-auto text-end mt-n1">
            @if ($shipment->admin_invoice)
                <a class="btn btn-outline-primary" href="{{ asset('storage/invoices/'.$shipment->admin_invoice) }}" target="_blank">Download Invoice</a>
            @else
    ...
    <div class="row">
        ...
        @if ($generate)
            <div class="col-lg-5" x-ref="generate" x-init="$refs.generate.scrollIntoView({ behaviour: 'smooth' })">
                <livewire:admin.shipments.generate-invoice :$shipment />
            </div>
        @endif
    </div>
</div>
