<div class="container-fluid p-0">
    <div class="card">
        <div class="card-header pb-0">
            <h5 class="card-title mb-0">Generate Carbon Offset Payment Invoice</h5>
        </div>
        <hr class="mb-0">
        <div class="card-body">
            <form wire:submit="generate" wire:confirm='Do you confirm that the entered details are correct? You will not be able to change it later!' class="p-0">
                ...
                <div class="my-3">
                    <div class="form-group">
                        <label class="form-label fw-bold">Invoice Month</label>
                        <input type="month" class="form-control" required wire:model="month">
                    </div>
                    @error('month')
                        <div class="text-danger"><small><i>{{ $message }}</i></small></div>
                    @enderror
