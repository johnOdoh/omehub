            ...
            @forelse ($request->quotes as $quote)
                    ...
                    <div class="card mb-4 p-0 rounded-4">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div>
                                        ...
                                        <div class="text-primary">{{ $request->currency }} {{ number_format($quote->custom+$quote->cost+$quote->insurance, 2) }}</div>
                                    </div>
                                </div>
                                <hr>
                            </div>
                            ...
                            <div class="text-end my-2">
                                <a href="#" class="px-3" data-bs-toggle="offcanvas" data-bs-target="#moreDetails" aria-controls="moreDetails" @click="$dispatch('loadJs')">Show details and charges</a>
                ...
                <div class="offcanvas offcanvas-end p-0" tabindex="-1" id="moreDetails" aria-labelledby="offcanvasLeftLabel">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between pb-4">
                                        ...
                                        <span class="text-primary fw-bold">{{ $request->currency }} {{ number_format($quote->cost, 2) }}</span>
                                    </div>
                                    {{-- <div class="ps-2 mt-2">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="text-primary fw-bold">{{ $request->currency }} {{ number_format($quote->custom+$quote->insurance, 2) }}</span>
                                    </div>
                                    <hr>
                                    <div class="ps-2 mt-2">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <strong>{{ $request->currency }} {{ number_format($quote->custom, 2) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ps-2 mt-2">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                <strong>{{ $request->currency }} {{ number_format($quote->insurance, 2) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-3">
                    ...
                    <div class="bg-light position-sticky bottom-0 w-100 d-flex justify-content-between p-3 text-primary" style="z-index: 1000;">
                        ...
                        <strong>{{ $request->currency }} {{ number_format($quote->cost+$quote->custom+$quote->insurance, 2) }}</strong>
                    </div>
                </div>
            @empty
                <div class="col-12">
