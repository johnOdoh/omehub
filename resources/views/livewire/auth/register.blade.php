    ...
    <form wire:submit="register" class="flex flex-col gap-6">
        ...
        <div class="flex items-center space-x-2">
            ...
            <label for="terms" class="text-sm">
                I agree to the <a href="{{ route('public.terms') }}" target="_blank" class="text-blue-600 hover:underline">Terms of Service</a> and <a href="{{ route('public.privacy') }}" target="_blank" class="text-blue-600 hover:underline">Privacy Policy</a>.
            </label>
        </div>
