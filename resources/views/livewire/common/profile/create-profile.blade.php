<div class="card-body">
    ...
    <form wire:submit="create" class="p-0">
        ...
        <div class="text-end my-3">
            <button type="button" class="btn btn-outline-primary me-1" x-on:click="$wire.closePage()" wire:loading.remove wire:target='create, logo'>Cancel</button>
            <button type="submit" class="btn btn-primary" wire:loading.remove wire:target='create, logo'>Create</button>
            <button class="btn btn-primary px-5" wire:loading wire:target='create, logo'>
